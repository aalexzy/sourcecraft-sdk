...
import (
	...
	"github.com/aalexzy/sourcecraft-sdk"
...
func TestPullRequestEventPayload_TypeSwitch(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			validatePRPayload: func(t *testing.T, payload sourcecraft.PullRequestEventPayload) {
		...
		},
		{
			...
			validateOtherPayload: func(t *testing.T, payload any) {
